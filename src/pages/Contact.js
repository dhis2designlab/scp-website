            ...
            <div className="pure-g content">
                <div className="pure-u-1-1 pure-u-md-4-5">
                    <div className="l-box">
                        ...
                        <div className="pure-g design-lab" style={designLabStyle}>
                            <div className="pure-u-1" style={designLabStyle.title}><h3>DHIS2 Design Lab</h3></div>
                            <div className="pure-u-3-5 pure-u-md-4-5 pure-u-lg-4-5">
                                ...
                                <p><a target="_blank" rel="noopener noreferrer" href="https://www.mn.uio.no/ifi/english/research/networks/hisp/dhis2-design-lab/">Contact DHIS2 Design Lab</a></p>
                            </div>
                            <div className="pure-u-2-5 pure-u-md-1-5 pure-u-lg-1-5">
                                <img alt="dhis2 design lab" style={designLabStyle.img} src={process.env.PUBLIC_URL + '/img/dhis2-design-lab-logo.png'} />
                            </div>
                        </div>
                        <div className="pure-g hisp" style={hispStyle}>

                            <div className="pure-u-1"> <h3>Health Information Systems Programme (HISP)</h3></div>
                            <div className="pure-u-4-5">
                                ...
                                <p><a target="_blank" rel="noopener noreferrer" href="https://www.mn.uio.no/ifi/english/research/networks/hisp/management-team.html">Contact HISP UiO Management team</a></p>
                            </div>
                        </div>
